...
struct DS_SQL_API FSQLiteIndex
{
...
USTRUCT(BlueprintType)
struct DS_SQL_API FSQLitePrimaryKey
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct DS_SQL_API FSQLiteTableField
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct DS_SQL_API FSQLiteTableRowSimulator
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct DS_SQL_API FSQLiteTable
{
	GENERATED_USTRUCT_BODY()
